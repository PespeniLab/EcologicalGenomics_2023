...
# for each file that has "MYSAMP" and "R1" (read 1) in the name 
# start a loop with this file as the input:

for READ1 in ${MYSAMP}*R1.fq.gz
do

# the partner to this file (read 2) can be found by replacing the R1.fastq.gz with R2.fq.gz
# second part of the input for PE reads

READ2=${READ1/R1.fq.gz/R2.fq.gz}
